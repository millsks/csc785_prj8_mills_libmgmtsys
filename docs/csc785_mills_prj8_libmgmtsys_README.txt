...
sudo mysql -u root -p < 01_project8_library_mgmt_system_ddl.sql
sudo mysql -u root -p < 02_project8_library_mgmt_system_dml.sql
sudo mysql -u root -p < 03_project8_library_mgmt_system_books_dml.sql
sudo mysql -u root -p < 04_project8_library_mgmt_system_create_views.sql
sudo mysql -u root -p < 05_project8_library_mgmt_system_create_view_users.sql
