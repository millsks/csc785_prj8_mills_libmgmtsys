...
INSERT INTO librarian_type (type_name, book_limit, duration_limit)
VALUES ('FACULTY', 10, 14),
       ('STUDENT', 5, 7);

/* Add LIBRARIAN records */
INSERT INTO librarian (name, librarian_type_id)
...
SELECT COUNT(*) librarian_type_count FROM librarian_type;
SELECT COUNT(*) librarian_count FROM librarian;
SELECT COUNT(*) book_count FROM book;
SELECT COUNT(*) patron_count FROM patron;
