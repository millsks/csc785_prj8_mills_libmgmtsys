...
grant select, insert, update, delete on * to libmgmtsys_user;
...
grant select on unknown_authors to unknown_authors_report_user;
...
grant select on book_multiple_copies to books_report_user;
